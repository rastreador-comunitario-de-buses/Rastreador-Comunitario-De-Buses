  ...
  <div class="contenedor">
    ...
    <div v-else>
      ...
      <div v-if="busSeleccionado" class="panelBus">
        <div class="contenedor-icono-reportes" @click="irAReportes" v-show="confirmarSesionMapa">
        ...
        <button v-show="confirmarSesionMapa" @click="guardarRuta">Guardar ruta</button>
      </div>
    </div>
  </div>
</template>
